...
class AssignmentServices(object):
    def __init__(self, assignment_repo, grades_repo):
        self.__assignment_repo = assignment_repo
        self.__grade_repo = grades_repo
    ...
    def remove(self, id: int) -> None:
        ...
        for student in self.__grade_repo._grades.keys():
            if id in self.__grade_repo[student]:
                self.__grade_repo.remove_assignment(student, id)
                continue
