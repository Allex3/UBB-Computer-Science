...
class StudentBinaryRepo(StudentMemoryRepo): # pragma: no cover
...
class AssignmentBinaryRepo(AssignmentMemoryRepo): # pragma: no cover
    def __init__(self, file_path: str):
        super().__init__()
        self.__file_path = file_path
        self.__load()
...
class GradeBinaryRepo(GradeMemoryRepo):# pragma: no cover
    def __init__(self, file_path: str):
        super().__init__()
        self.__file_path = file_path
        self.__load()
